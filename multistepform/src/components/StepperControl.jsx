...
const StepperControl = ({handleClick, currentStep, steps}) => {
  return <div className='container flex justify-around mt-4 mb-8'>
    ...
    <button
    onClick={() => handleClick()} className={`bg-white text-slate-400 uppercase py-2 px-4 rounded-xl
    ...
    {/* next button */}
    <button
    onClick={()=> handleClick("next")} className='bg-blue-500 text-white uppercase py-2 px-4 rounded-xl
    font-semibold cursor-pointer border-2 border-slate-300 hover:bg-slate-700
